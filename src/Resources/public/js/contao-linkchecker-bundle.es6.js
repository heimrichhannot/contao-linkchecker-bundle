(function() {
    ...
    LinkCheckerRegistry = {
        ...
        runRecursiveFunction: function(func, args, callback) {
            if (args.length < 1) {
            ...
            let argument = args[0],
                remainingArguments = Array.prototype.slice.call(args, 1);
            ...
            (function(_this) {
                ...
                function myFunc(element, remainingElements, callback) {
                    ...
                    if (_this.stopRecursion) {
                        ...
                        for (let i = 0, len = _requests.length; i < len; i++) {
                            let xhr = _requests[i];
                            xhr.abort();
                        }
                    ...
                    let lc = new LinkChecker(element, config);
